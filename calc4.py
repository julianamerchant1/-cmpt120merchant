...
from button import *
# Bullet 3: button class used
class Calculator:
# impliments simple GUI
    def __init__(self):
        pass
# unsure how to implement init in an alternative fashion to improve this ^    
...
# 'create a calculator object'
        theCalc = Calculator()
# call run method
#says 'Calculator' is not defined, but the class was created above
        theCalc.run()
